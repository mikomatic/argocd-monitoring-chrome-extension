    ...
    chrome.storage.local.get(
      ...
      function (result: any) {
        if (result && result.argoEnvironmentConfiguration) {
          ...
          let configuration =
            result.argoEnvironmentConfiguration as ArgoEnvironmentConfiguration;
  ...
  useEffect(() => {
    function saveArgoEnvConfToLocalStorage(newEnvs: ArgoEnvironment[]) {
      ...
      chrome.storage.local.set(
        { argoEnvironmentConfiguration: argoConf },
        function () {
          if (chrome.runtime.lastError) console.debug('Error setting');
